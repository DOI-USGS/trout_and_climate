    ...
    <div class="tmp-container">
      ...
      <div class="footer-social-links">
        <ul class="social">
          ...
          <li class="facebook">
            <a href="https://facebook.com/USGSWater/" target="_blank" aria-label="facebook link">
              <font-awesome-icon :icon="{ prefix: 'fab', iconName: 'facebook-square' }" class="fa fa-facebook-square"><span class="only">Facebook</span></font-awesome-icon>
            </a>
          </li>
          <li class="github">
            <a href="https://github.com/DOI-USGS" target="_blank" aria-label="github link">
              <font-awesome-icon :icon="{ prefix: 'fab', iconName: 'github' }" class="fa fa-github"><span class="only">GitHub</span></font-awesome-icon>
            </a>
          </li>
          <li class="flickr">
            <a href="https://flickr.com/usgeologicalsurvey" target="_blank" aria-label="flickr link">
              <font-awesome-icon :icon="{ prefix: 'fab', iconName: 'flickr' }" class="fa fa-flickr"><span class="only">Flickr</span></font-awesome-icon>
            </a>
          </li>
          <li class="youtube">
            <a href="http://youtube.com/usgs" target="_blank" aria-label="youtube link">
              <font-awesome-icon :icon="{ prefix: 'fab', iconName: 'youtube-square' }" class="fa fa-youtube-play"><span class="only">YouTube</span></font-awesome-icon>
            </a>
          </li>
          <li class="instagram">
            <a href="https://instagram.com/usgs_water" target="_blank" aria-label="instagram link">
              <font-awesome-icon :icon="{ prefix: 'fab', iconName: 'instagram' }" class="fa fa-instagram"><span class="only">Instagram</span></font-awesome-icon>
            </a>
          </li>
        </ul>
      </div>
