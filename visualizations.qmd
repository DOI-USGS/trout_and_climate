...
```{r verify}
# There should be three groups of fish sizes
table(raw_data$fish_size)

# And three groups of water temperatures
table(raw_data$water_status)

# And 9 different file names
table(raw_data$filename)
