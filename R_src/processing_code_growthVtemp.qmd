...
color_cold_stress <- "#C96868"
color_warm_optimal <- "#7EACB5"
color_warm_stress <- "#C96868"
...
ggplot(data = cold_fish, aes(y = fish_growth, x = aveT)) +
  ...
  annotate("ribbon", ymax = rep(0.027, nrow(cold_adapted_stress)), 
           ymin = cold_adapted_stress$fish_growth, 
            alpha = 0.2, fill = color_cold_stress, linewidth = 10,
           x = cold_adapted_stress$aveT) +
  ...
  annotate("ribbon", ymax = rep(0.026, nrow(warm_adapted_stress)), 
           ymin = warm_adapted_stress$fish_growth, 
            alpha = 0.2, fill = color_warm_stress, linewidth = 10,
           x = warm_adapted_stress$aveT) +
  # x-axis 
  annotate(geom = "text", y = rep(0.024, 4), x = c(0, 10, 20, 30), 
           label = c(0, 10, 20, 30), 
           size = 10, color = "grey50", hjust = 0.5) +
  annotate(geom = "text", label = "degrees Celsius", hjust = 0, 
           x = 0.5, y = 0.024, size = 10, color = "grey50") +
  annotate(geom = "line", y = c(0.022, 0.018), x = rep(0, 2),
           linewidth = 0.8, color = "grey60") +
  annotate(geom = "line", y = c(0.022, 0.018), x = rep(10, 2),
           linewidth = 0.8, color = "grey60") +
  annotate(geom = "line", y = c(0.022, 0.018), x = rep(20, 2),
           linewidth = 0.8, color = "grey60") +
  annotate(geom = "line", y = c(0.022, 0.018), x = rep(30, 2),
           linewidth = 0.8, color = "grey60") +
  # y-axis
  ...
  annotate(geom = "text", y = 0.030, x = -4,          
           ...
           color = "black", hjust = 0.05, size = 14, vjust = 0, family = font_main, fontface = "bold") +
  # highlights
  ...
  geom_line(data = cold_adapted_stress, aes(y = 0.027), alpha = 0.7, 
            color = color_cold_stress, linewidth = 10) +  
  geom_line(data = warm_adapted_optimal, aes(y = 0.026), 
            alpha = 0.7, color = color_cold_optimal, linewidth = 10) +
  geom_line(data = warm_adapted_stress, aes(y = 0.026), alpha = 0.7, 
            color = color_cold_stress, linewidth = 10) +
  ...
  annotate("text", label = "Thermal stress", color = color_cold_stress,
           x = 20, y = 0.0285, fontface = "bold",
           hjust = 0, size = 10) +
  annotate("text", label = rep("Cold-adapted fish", 2), color = "black", 
           y = c(-0.0083, 0.027), x = c(24.5, 0),
           hjust = 0, size = 10, fontface = "bold") +
  annotate("text", label = rep("Warm-adapted fish", 2), color = "black", 
           y = c(-0.005, 0.026), x = c(29, 0),
           hjust = 0, size = 10, fontface = "bold") +
  # growth curves
