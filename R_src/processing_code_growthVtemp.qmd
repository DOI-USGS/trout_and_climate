...
if(!file.exists("in/sciencebase/base10.csv")){
  ...
  archive::archive_extract(
    ...
    dir = "in/second_data_release/Blitzen_PRMS_output.zip")
}
```
...
dead_fish <- magick::image_read("in/dead_fish.png")

# Load in the thermometers (cold/warm/hot)
cold_therm_pic <- magick::image_read("in/cold_temp.png")

warm_therm_pic <- magick::image_read("in/warm_temp.png")

hot_therm_pic <- magick::image_read("in/hot_temp.png")
```
...
ggsave(filename = "out/20240223_test.png", width = 9, height = 9, dpi = 300)
```
...
ggsave(filename = "out/20240223_test_02.png", width = 9, height = 9, dpi = 300)
```
...
ggsave(filename = "out/20240223_test_03.png", width = 9, height = 9, dpi = 300)
```