...
ggplot(data = cold_fish, aes(y = fish_growth, x = aveT)) +
  ...
  annotate(geom = "text", label = "degrees Celsius", hjust = 0, 
           x = 0.5, y = 0.028, size = 14, color = "grey50") +
  ...
  annotate(geom = "text", label = "0\ng/g/day", x = -0.6, y = 0, 
           hjust = 1, size = 14, color = "grey50", lineheight = 0.8, vjust = 0.8) +
  ...
  annotate(geom = "text", y = 0.030, x = -4,          
           label = "Growth rate versus stream temperature for Redband Trout",
           color = "black", hjust = 0.02, size = 18, vjust = 0, 
  ...
  #         y = c(-0.0095, 0.026), x = c(29.8, 19),
  #         hjust = 1, size = 14, fontface = "bold") +
  #annotate("text", label = rep("Warm-adapted", 2), color = "black", 
  #         y = c(-0.0058, 0.0245), x = c(34.8, 19),
  #         hjust = 1, size = 14, fontface = "bold") +
  # growth curves
