...
ggplot(data = cold_fish, aes(y = fish_growth, x = aveT)) +
  ...
  geom_line(data = cold_adapted_optimal, alpha = 0.4, color = "green", linewidth = 10) +
  geom_line(data = cold_adapted_stress, alpha = 0.4, color = "red", linewidth = 10) +  
  geom_line(data = warm_adapted_optimal, alpha = 0.4, color = "green", linewidth = 10) +
  geom_line(data = warm_adapted_stress, alpha = 0.4, color = "red", linewidth = 10) +
  # mini bar charts
  geom_line(data = cold_adapted_optimal, aes(y = 0.027), alpha = 0.4, color = "green", linewidth = 10) +
  geom_line(data = cold_adapted_stress, aes(y = 0.027), alpha = 0.4, color = "red", linewidth = 10) +  
  geom_line(data = warm_adapted_optimal, aes(y = 0.026), alpha = 0.4, color = "green", linewidth = 10) +
  geom_line(data = warm_adapted_stress, aes(y = 0.026), alpha = 0.4, color = "red", linewidth = 10) +
  # growth curves
