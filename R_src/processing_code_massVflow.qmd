...
circle_form <- 
  magick::image_read("../public/assets/vectorized_pngs/rawcircle.png") |>
  magick::image_colorize(opacity = 100, color = "red")
```
...
(mass_streamflow_plot <-
    ...
    geom_point(shape = 19, size = 1, color = redband, alpha = 0.6) + 
    ...
    geomtextpath::geom_textsmooth(data = trout.mass, 
                                  aes(x = AugStreamflow_1, y = quant_reg_predicted, 
                                      label = "Approximate top limit on size"),
                                  color = "black", size = 8, vjust = -.2, hjust = 0.8,
                                  linecolor = NA, family = "xkcd") +
    xlab("August Streamflow (cfs)") +
    ylab("Fish Mass (g)") +
    guides(color = "none",
           linewidth = "none") +
...
ggdraw(ylim = c(0,1), 
  ...
  draw_plot(mass_streamflow_plot,
            ...
            height = 0.900,
            width = 0.900) +
  draw_image(circle_form, 
             x = 0.18, y = -0.25,
             width = 0.2)

ggsave(filename = "../public/assets/vectorized_pngs/scatter_cold.png", 
...
ggdraw(ylim = c(0,1), 
  ...
  draw_image(circle_form, 
             x = 0.65, y = -0.1,
             width = 0.28)
ggsave(filename = "../public/assets/vectorized_pngs/scatter_warm.png", 
       width = 9, height = 7, dpi = 300)
```