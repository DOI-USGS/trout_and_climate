...
(mass_streamflow_plot <-
    ...
    annotate(geom = "text", y = 0, x = 0.05, hjust = 1, label = "0 g ", size = 10, color = "grey60") +
    annotate(geom = "line", y = rep(200, 2), x = c(0.1, 100),
             linewidth = 0.8, color = "grey60") +
    annotate(geom = "text", y = 200, x = 0.1, hjust = 1, label = "200 g ", size = 10, color = "grey60") +
    annotate(geom = "line", y = rep(400, 2), x = c(1, 100),
             linewidth = 0.8, color = "grey60") +
    annotate(geom = "text", y = 400, x = 1.0, hjust = 1, label = "400 g ", size = 10, color = "grey60") +
    annotate(geom = "line", y = rep(600, 2), x = c(10, 100),
             linewidth = 0.8, color = "grey60") +
    annotate(geom = "text", y = 600, x = 10, hjust = 1, label = "600 g ", size = 10, color = "grey60") +
    # limit on growth line
    geom_line(aes(y = quant_reg_predicted),
              linewidth = 2.4) +  
    # title
    annotate(geom = "text", y = 600, x = 0.05,
             label = "Top limit on size in grams (g) for\n~95% of Redband Trout\nbased on streamflow\nin cubic feet per second (cfs)",
    ...
    #                              linecolor = NA, family = font_supp, fontface = "bold") +
