...
(mass_streamflow_plot <-
    ...
    annotate(geom = "text", y = 600, x = 0.05,
             label = "Redband Trout body size versus streamflow",
...
# Convert to webp
img <- png::readPNG("../public/assets/vectorized_pngs/page06.png")
webp::write_webp(img, "../public/assets/vectorized_pngs/page06.webp")
