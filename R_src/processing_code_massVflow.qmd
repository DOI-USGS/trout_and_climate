...
(mass_streamflow_plot <-
    ...
    # y-axis
    annotate(geom = "line", y = rep(0, 2), x = c(0.05, 100),
             linewidth = 0.8, color = "grey60") +
    annotate(geom = "text", y = 0, x = 0.05, hjust = 1, label = "0 g ", size = 10, color = "grey50") +
    annotate(geom = "line", y = rep(200, 2), x = c(0.1, 100),
             linewidth = 0.8, color = "grey60") +
    annotate(geom = "text", y = 200, x = 0.1, hjust = 1, label = "200 g ", size = 10, color = "grey50") +
    annotate(geom = "line", y = rep(400, 2), x = c(1, 100),
             linewidth = 0.8, color = "grey60") +
    annotate(geom = "text", y = 400, x = 1.0, hjust = 1, label = "400 g ", size = 10, color = "grey50") +
    annotate(geom = "line", y = rep(600, 2), x = c(10, 100),
             linewidth = 0.8, color = "grey60") +
    annotate(geom = "text", y = 600, x = 10, hjust = 1, label = "600 g ", size = 10, color = "grey50") +
    # x-axis 
    annotate(geom = "text", y = rep(-20, 4), x = c(0.1, 1.0, 10, 100), 
             label = c("0.1", "1.0", "10", "100"), 
             size = 10, color = "grey50", hjust = 0.5) +
    annotate(geom = "text", label = "cubic feet per second", hjust = 0, 
             x = 0.12, y = -20, size = 10, color = "grey50") +
    ...
    annotate(geom = "text", y = 600, x = 0.05,
             label = "Top limit on body size\nfor ~95% of Redband Trout\nbased on streamflow",
             color = "black", hjust = 0, size = 14, vjust = 1, family = font_main, fontface = "bold") +
