...
ggplot(data = trout.mass, aes(y = massInit, x = AugStreamflow_1)) +
  geom_point(shape = 19, size = 2, aes(color = MaxFishLength)) + 
  geom_line(aes(y = quant_reg_predicted,
                linewidth = 1.2,
                color = quant_reg_predicted)) +
...
ggsave(filename = "public/assets/vectorized_pngs/scatterRaw.png", width = 9, height = 9, dpi = 300)
```