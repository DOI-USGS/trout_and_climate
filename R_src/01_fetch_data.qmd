...
Data for the Miller et al. (2018) data release were saved to gitlab. The ScienceBase data release includes stream data in over 2,600,000 csv files. This saves the streams as one combined csv that are needed for analysis. The 64 streams used in this analysis are:
